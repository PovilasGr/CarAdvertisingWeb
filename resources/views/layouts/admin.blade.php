        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/admin/carbrands') }}" class="nav-link">
                            <i class="nav-icon fas fa-book"></i>
                            <p>Car Brands</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/admin/cartypes') }}" class="nav-link">
                            <i class="nav-icon fas fa-user-edit"></i>
                            <p>Car Types</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/admin/fueltypes') }}" class="nav-link">
                            <i class="nav-icon fas fa-landmark"></i>
                            <p>Fuel Types</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/admin/carads') }}" class="nav-link">
