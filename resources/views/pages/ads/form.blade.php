...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if(isset($carad))
                {!! Form::model($carad, ['url' => ['carads', $carad->id], 'method' => 'patch', 'enctype' => 'multipart/form-data']) !!}
            @else
                {!! Form::open(['url' => 'carads', 'enctype' => 'multipart/form-data']) !!}
            @endif
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::select('car_brand_id', $carbrands, null, ['class' => 'select-field custom-select-field', 'style' => 'width: 200px;', 'required' => 'required']) !!}
                        @error('car_brand_id')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::select('car_type_id', $cartypes, null, ['class' => 'select-field custom-select-field', 'style' => 'width: 200px;', 'required' => 'required']) !!}
                        @error('car_type_id')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::select('fuel_type_id', $fueltypes, null, ['class' => 'select-field custom-select-field', 'style' => 'width: 200px;', 'required' => 'required']) !!}
                        @error('fuel_type_id')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::select('year', $years, null, ['class' => 'select-field custom-select-field', 'style' => 'width: 200px;', 'required' => 'required']) !!}
                        @error('year')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::select('car_condition', $carconditions, null, ['class' => 'select-field custom-select-field', 'style' => 'width: 200px;', 'required' => 'required']) !!}
                        @error('car_condition')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
